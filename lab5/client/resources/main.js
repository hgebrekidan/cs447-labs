...
window.onload = function() {
    ...
    document.getElementById('signup').onclick = function dispalysignUpPage(event){
        event.preventDefault();
...
function renderProduct(prod) {
    ...
    div.id = prod.id;
    div.innerHTML = `<svg class="bd-placeholder-img width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
    ...
    deleteBtn.addEventListener('click', function(event) {
        ...
        fetch('http://localhost:3000/books/' + prod.id, {
            ...
            alert('book deleted from the cart Successfully!');
            div.remove();
        });
    });
